                            ...
                            if(type.equals("receieve"))
                            {
                                ...
                                UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        final String requestUserName=dataSnapshot.child("names").getValue().toString();
                            ...
                            else if(type.equals("sent"))
                            {
                                ...
                                UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        requestsViewHolder.userName.setText(requestUserName);
                                        requestsViewHolder.userStatus.setText("you have sent a request");
